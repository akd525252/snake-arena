...
// import solanaDepositRoutes from './routes/solanaDeposit'; // Coming soon
...
// app.use('/api/solana', solanaDepositRoutes); // Coming soon
...
<body>
  <div class="card">
    ...
    <ul>
      ...
      <!-- <li><code>/api/solana</code> &mdash; Solana (SPL) USDT Auto-Deposits (Coming Soon)</li> -->

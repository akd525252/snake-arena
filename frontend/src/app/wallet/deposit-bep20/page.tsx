            ...
            <div className="rpg-panel p-6 text-center">
              ...
              <div className="mt-4 space-y-1">
                <div className="flex items-center justify-center gap-2 text-xs">
                  ...
                  <span className="rpg-text">{t.depositPage.network}: <span className="rpg-gold-bright font-bold">BEP20 (BSC)</span></span>
                </div>
                <div className="flex items-center justify-center gap-2 text-xs">
                  <span className="w-2 h-2 rounded-full bg-[#39ff14]" />
                  <span className="rpg-text">{t.depositPage.token}: <span className="rpg-gold-bright font-bold">USDT</span></span>
                </div>
                <div className="flex items-center justify-center gap-2 text-xs">
